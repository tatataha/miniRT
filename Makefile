...
CFLAGS		= -Wall -Wextra -Werror -I./mlx_macos -O3
...
MANDATORY_FILES += debug debug_01 debug_02
MANDATORY_FILES += pixel color ray light render
MANDATORY_FILES += vector vector_operations vector_extensions
MANDATORY_FILES += scene shape lightsource sphere plane cylinder
MANDATORY_FILES += message math normal
...
BONUS_DEBUG += debug debug_01 debug_02
BONUS_RENDER += pixel color ray light light_01 render
BONUS_VEC += vector vector_operations vector_operations_01
BONUS_ENTITIES += scene shape lightsource sphere plane cylinder cone
BONUS_UTILS += message math normal shape_constants
